...
export default function Footer() {
  return (
    <footer
      className="bg-gradient-to-r from-green-600 to-green-900 text-white py-10
"
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm justify-items-center">
          ...
          <div className="mb-8 md:mb-0">
            <h1 className="text-2xl font-bold text-white mb-4">Useful Links</h1>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4 mt-6">
              <a
                href="#"
                className="w-8 h-8 flex items-center justify-center bg-white text-pink-600 rounded-full hover:bg-pink-200"
              >
