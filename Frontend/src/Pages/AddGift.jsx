  ...
  return (
    <div className="p-6 bg-gradient-to-b from-[rgba(254,129,128,0.3)] via-[rgba(255,255,255,0.3)] to-[rgba(254,143,142,0.3)] min-h-screen">
      <div className="p-3 max-w-3xl mx-auto min-h-screen">
        <h1 className="text-center text-3xl my-7 font-semibold">Add Gifts</h1>
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-4 sm:flex-row justify-between">
            ...
            >
              ...
              <option value="Toys">Soft Toys</option>
          ...
          <ReactQuill
            ...
            value={formData.description} // Ensure value is controlled
            onChange={(value) => {
              setFormData({ ...formData, description: value }); // Keep HTML
            }}
          />
