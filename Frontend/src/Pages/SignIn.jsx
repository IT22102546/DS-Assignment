...
export default function SignIn() {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none bg-gradient-to-b from-[rgba(144,238,144,0.3)] via-[rgba(255,255,255,0.3)] to-[rgba(152,251,152,0.3)] text-gray-800 placeholder-gray-700">
            ...
            <div className="relative w-full max-w-md px-4 py-2 rounded-3xl border border-gray-300 focus:outline-none bg-gradient-to-b from-[rgba(144,238,144,0.3)] via-[rgba(255,255,255,0.3)] to-[rgba(152,251,152,0.3)] text-gray-800 placeholder-gray-700 p-6 shadow-lg z-10">
                ...
                <form className="flex flex-col gap-4 mt-5 p-5 " onSubmit={handleSubmit}>
                    ...
                    <Button className="max-w-md w-3/4 bg-[#4CAF50] hover:bg-[#45a049] mx-auto flex items-center justify-center" disabled={loading} type="submit">
                ...
                <div className="flex gap-2 text-sm mt-5">
                    ...
                    <button className="text-[#4CAF50]" onClick={() => { setIsSignUp(!isSignUp); setFormData({}); setError(false); }}>
                ...
                <div className="flex gap-2 text-sm mt-5 ">
                    ...
                    <Link to='/forgetPassword' className="text-[#4CAF50]">Click Here</Link>
                </div>
