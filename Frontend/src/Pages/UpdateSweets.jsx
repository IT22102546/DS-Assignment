...
export default function UpdateSweet() {
  ...
  return (
    ...
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
      <h1 className="text-center text-pink-800 text-3xl my-7 font-semibold">Update Products</h1>
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <Button type='submit'  className="max-w-md w-full bg-[#FE8180] hover:bg-[#e57373] mx-auto flex items-center justify-center">Update Sweets</Button>
        {publishError && (
