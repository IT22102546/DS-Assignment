...
const DashMyEventBooking = () => {
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            ...
            try {
                const response = await fetch(`/api/events/mybookings/${currentUser._id}`); // Use Redux user ID
    ...
    return (
        <div>
            <h2 className="text-pink-800">Event Bookings</h2>
...
export default DashMyEventBooking;
